...
export const todoById = async (event: any, context: any) => {
  console.log('TODO_BY_ID_EVENT: ', event);
  console.log('TODO_BY_ID_CONTEXT: ', context);
...
export const createTodo = async (event: any, context: any) => {
  console.log('CREATE_TODO_EVENT: ', event);
  console.log('CREATE_TODO_CONTEXT: ', context);
...
export const updateTodo = async (event: any, context: any) => {
  console.log('UPDATE_TODO_EVENT: ', event);
  console.log('UPDATE_TODO_CONTEXT: ', context);
  const { id } = event.pathParameters;
  const { title, description } = JSON.parse(event.body);
  const todo = TODOS_DATA.find((todo) => todo.id == id);
  if (!todo) {
...
export const deleteTodo = async (event: any, context: any) => {
  console.log('DELETE_TODO_EVENT: ', event);
  console.log('DELETE_TODO_CONTEXT: ', context);
  const { id } = event.pathParameters;
